...
export const createComment = (documentId: string, body: string, versionId?: string | null) =>
  client.post<DocumentDetailTimelineItem>(`/collaboration/documents/${documentId}/comments`, { body, version_id: versionId ?? null })
